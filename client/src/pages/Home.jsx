  ...
  return (
    <div className="min-h-screen bg-[#f9f5ee] text-slate-900">
      ...
      <section className="relative overflow-hidden border-b border-orange-100/60 bg-gradient-to-b from-[#fbf7ef] to-[#f4ebdd]">
        ...
        <div className="max-w-6xl mx-auto px-6 sm:px-10 pt-4 flex justify-end items-center gap-3">
          {authChecked && (
            user ? (
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="rounded-full border border-slate-300 bg-white px-3 py-2 text-sm font-medium text-slate-600 hover:bg-slate-50 transition-colors"
                >
                  Log out
                </button>
              </div>
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-full border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-slate-700 shadow-sm hover:bg-slate-50 transition-colors"
              >
